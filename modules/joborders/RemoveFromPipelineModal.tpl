    ...
    <form action="<?php echo(CATSUtility::getIndexName()); ?>?m=joborders&amp;a=removeFromPipeline" method="post">
        ...
        <div class="ui2-card ui2-card--section">
            <div class="pipeline-remove-header">
                <h2 class="pipeline-remove-title">Reject Candidate</h2>
                <div class="pipeline-remove-subtitle">This candidate will be marked as rejected from this job order pipeline.</div>
            </div>
