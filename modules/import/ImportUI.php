    ...
    */
    ...
    public function massImport($step = 1)
    {
        ...
        if ($step == 1) {
            ...
            if (
                !count($importedCandidates) && !count($importedDocuments) && !count($importedFailed) &&
    ...
    {
        if (
            !isset($_SESSION['CATS_PARSE_TEMP']) || empty($_SESSION['CATS_PARSE_TEMP']) ||
