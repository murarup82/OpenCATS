            ...
            <div class="customerDashPage">
                ...
                <?php else: ?>
                    <?php
                        ...
                        $dashboardDetailsBaseURL = CATSUtility::getIndexName() . '?m=reports&amp;a=customerDashboardDetails&amp;companyID=' . (int) $this->selectedCompanyID . '&amp;rangeDays=' . (int) $this->rangeDays . '&amp;activityType=' . urlencode($selectedActivityType);
                    ?>
                    ...
                    <div class="customerDashMuted" style="margin-bottom: 8px;">Click a metric value to open a detailed report page.</div>

                    <div class="customerDashCards">
                        <div class="customerDashCard">
                            <div class="customerDashCardLabel">Open Job Orders</div>
                            <div class="customerDashCardValue"><a class="customerDashCardValueLink" href="<?php echo($dashboardDetailsBaseURL); ?>&amp;focusMetric=openJobOrders"><?php echo((int) $snapshot['openJobOrders']); ?></a></div>
                        ...
                        <div class="customerDashCard">
                            ...
                            <div class="customerDashCardValue"><a class="customerDashCardValueLink" href="<?php echo($dashboardDetailsBaseURL); ?>&amp;focusMetric=currentHires"><?php echo((int) $snapshot['hiresInRange']); ?></a></div>
                        ...
                        <div class="customerDashCard">
                            ...
                            <div class="customerDashCardValue"><a class="customerDashCardValueLink" href="<?php echo($dashboardDetailsBaseURL); ?>&amp;focusMetric=confirmedFutureHires"><?php echo((int) $snapshot['confirmedFutureHires']); ?></a></div>
                        ...
                        <div class="customerDashCard">
                            ...
                            <div class="customerDashCardValue"><a class="customerDashCardValueLink" href="<?php echo($dashboardDetailsBaseURL); ?>&amp;focusMetric=activePipeline"><?php echo((int) $snapshot['activePipelineCount']); ?></a></div>
                        ...
                        <div class="customerDashCard">
                            ...
                            <div class="customerDashCardValue"><a class="customerDashCardValueLink" href="<?php echo($dashboardDetailsBaseURL); ?>&amp;focusMetric=offerAcceptance"><?php $this->_($snapshot['offerAcceptanceLabel']); ?></a></div>
                        ...
                        <div class="customerDashCard">
                            ...
                            <div class="customerDashCardValue"><a class="customerDashCardValueLink" href="<?php echo($dashboardDetailsBaseURL); ?>&amp;focusMetric=aging0to15"><?php echo((int) $aging['bucket0to15']); ?></a></div>
                            <div class="customerDashCardMeta">Fresh openings</div>
                        </div>
                        <div class="customerDashCard">
                            <div class="customerDashCardLabel">Aging 16-30 days</div>
                            <div class="customerDashCardValue"><a class="customerDashCardValueLink" href="<?php echo($dashboardDetailsBaseURL); ?>&amp;focusMetric=aging16to30"><?php echo((int) $aging['bucket16to30']); ?></a></div>
                            <div class="customerDashCardMeta">Needs active funneling</div>
                        </div>
                        <div class="customerDashCard">
                            <div class="customerDashCardLabel">Aging 31+ days</div>
                            <div class="customerDashCardValue"><a class="customerDashCardValueLink" href="<?php echo($dashboardDetailsBaseURL); ?>&amp;focusMetric=aging31plus"><?php echo((int) $aging['bucket31plus']); ?></a></div>
