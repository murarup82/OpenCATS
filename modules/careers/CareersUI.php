...
class CareersUI extends UserInterface
{
    ...
    private function onApplyToJobOrder($siteID, $candidateID = false)
    {
        ...
        /* Upload resume (with questionnaire) */ else if (isset($_POST['file']) && !empty($_POST['file'])) {
            $resumePath = '';
        ...
        if (
            !isset($candidatesEmailTemplateRS['textReplaced']) ||
    ...
    private function ProcessCandidateRegistration($siteID, $template, $cookieFields = array(), $ignorePost = false)
    {
        ...
        foreach ($matches[1] as $tag) {
            ...
            if (
                !strcasecmp('submit', $tag) || !strcasecmp('new', $tag) || !strcasecmp('registered', $tag) ||
