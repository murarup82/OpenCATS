...
const checks = [
  ...
  { id: 'verifyUnexpectedLegacyRedirects', label: 'Unexpected Legacy Redirect Guard', command: ['run', 'verify:no-unexpected-legacy-redirects'], required: true },
...
const evidenceFiles = [
  ...
  'docs/modern-ui-unexpected-legacy-redirects-check.md',
