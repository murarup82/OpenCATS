...
function resolvePageCopy(actionName: string): { title: string; subtitle: string } {
  ...
  if (normalizedAction === 'add') {
    return {
      title: 'Add Company',
      subtitle: 'Create a company profile in the modern shell with legacy-safe form behavior.'
    };
  }

  return {
    title: 'Edit Company',
    subtitle: 'Update company details using the proven legacy form inside the modern UI.'
  };
}
