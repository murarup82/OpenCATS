  ...
  return (
    <section className="modern-compat-page modern-compat-page--forward">
      <header className="modern-compat-page__header">
        <div>
          <h2 className="modern-compat-page__title">Job Order Form Redirect</h2>
          <p className="modern-compat-page__subtitle">
            The job order form continues in the legacy endpoint while the modern shell keeps the handoff visible.
          </p>
        </div>
      ...
      <section className="avel-list-panel">
        <div className={`modern-state${canContinue ? '' : ' modern-state--error'}`} aria-live="polite">
          {canContinue
            ? 'Preparing legacy job order form redirect...'
            : 'Legacy job order form URL is unavailable for this route.'}
        </div>
      </section>
    </section>
  );
    ...
    <div className="avel-dashboard-page">
      ...
      >
        <div className="modern-dashboard avel-dashboard-shell">
          <JobOrderForwardPanel legacyURL={bootstrap.legacyURL} />
          <section className="avel-list-panel">
            <div className="avel-list-panel__header">
              <h2 className="avel-list-panel__title">Quick Navigation</h2>
              <p className="avel-list-panel__hint">Use these links to move between the modern shell and the job order list.</p>
            </div>
