...
const explicitNativeActionRoutes: Record<string, ModernRouteComponent> = {
  ...
  'joborders.edithiringplan': LegacyActionWorkspacePage,
  ...
  'reports.customizeeeoreport': LegacyActionWorkspacePage,
  'reports.customizejoborderreport': LegacyActionWorkspacePage,
  'reports.generateeeoreportpreview': LegacyActionWorkspacePage,
  'reports.generatejoborderreportpdf': LegacyActionWorkspacePage,
  'reports.showhirereport': LegacyActionWorkspacePage,
  'reports.showplacementreport': LegacyActionWorkspacePage,
  'reports.showsubmissionreport': LegacyActionWorkspacePage,
  ...
  'settings.getfirefoxmodal': LegacyActionWorkspacePage,
