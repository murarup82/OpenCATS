...
define('PIPELINE_STATUS_NEW',                 100);
define('PIPELINE_STATUS_HR_VALIDATED',        200);
define('PIPELINE_STATUS_REQUIRE_TECH_EVAL',   250);
define('PIPELINE_STATUS_TECH_VALIDATED',      300);
define('PIPELINE_STATUS_PROPOSED_TO_CUSTOMER_LEGACY', 400);
define('PIPELINE_STATUS_APPROVED_BY_CUSTOMER_LEGACY', 500);
define('PIPELINE_STATUS_UNDER_OFFER_NEGOTIATION_LEGACY', 600);
define('PIPELINE_STATUS_CLIENT_DECISION_PENDING', 650);
define('PIPELINE_STATUS_OFFER_ACCEPTED_LEGACY', 700);
define('PIPELINE_STATUS_ACTIVITY_STARTED',    800);

/* Candidate↔JobOrder flow (v1) statuses. */
define('PIPELINE_STATUS_ALLOCATED',           9000);
define('PIPELINE_STATUS_DELIVERY_VALIDATED',  9001);
define('PIPELINE_STATUS_PROPOSED_TO_CUSTOMER',9002);
define('PIPELINE_STATUS_CUSTOMER_INTERVIEW',  9003);
define('PIPELINE_STATUS_CUSTOMER_APPROVED',   9004);
define('PIPELINE_STATUS_AVEL_APPROVED',       9005);
define('PIPELINE_STATUS_OFFER_NEGOTIATION',   9006);
define('PIPELINE_STATUS_OFFER_ACCEPTED',      9007);
define('PIPELINE_STATUS_REJECTED',            9008);
define('PIPELINE_STATUS_HIRED',               800);
