...
define('PIPELINE_STATUS_PROPOSED_TO_CUSTOMER',400);
define('PIPELINE_STATUS_APPROVED_BY_CUSTOMER',500);
define('PIPELINE_STATUS_UNDER_OFFER_NEGOTIATION', 600);
define('PIPELINE_STATUS_CLIENT_DECISION_PENDING', 650);
define('PIPELINE_STATUS_OFFER_ACCEPTED',      700);
