...
1. Move remaining candidate/joborder profile actions (attachments/tags/history/report and attachment delete) from popup/form-post flows to native mutation + optimistic refresh patterns.
