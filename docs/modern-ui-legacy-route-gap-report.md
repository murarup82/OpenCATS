...
Generated: 2026-03-04T05:14:55.456Z
...
| import | deleteBulkResumes | native-explicit | import.deletebulkresumes | LegacyUtilityForwardActionPage |
| import | import | native-explicit | import.import | ImportLauncherPage |
| import | importBulkResumes | native-explicit | import.importbulkresumes | LegacyUtilityForwardActionPage |
| import | importSelectType | native-explicit | import.importselecttype | LegacyUtilityForwardActionPage |
| import | importUploadFile | native-explicit | import.importuploadfile | ImportLauncherPage |
| import | importUploadResume | native-explicit | import.importuploadresume | LegacyUtilityForwardActionPage |
| import | massImport | native-explicit | import.massimport | LegacyUtilityForwardActionPage |
| import | massImportDocument | native-explicit | import.massimportdocument | LegacyUtilityForwardActionPage |
| import | massImportEdit | native-explicit | import.massimportedit | LegacyUtilityForwardActionPage |
| import | revert | native-explicit | import.revert | LegacyUtilityForwardActionPage |
| import | showMassImport | native-explicit | import.showmassimport | LegacyUtilityForwardActionPage |
| import | viewerrors | native-explicit | import.viewerrors | LegacyUtilityForwardActionPage |
| import | viewpending | native-explicit | import.viewpending | LegacyUtilityForwardActionPage |
| import | whatIsBulkResumes | native-explicit | import.whatisbulkresumes | LegacyUtilityForwardActionPage |
...
| settings | administration | native-explicit | settings.administration | LegacyUtilityForwardActionPage |
...
| settings | aspLocalization | native-explicit | settings.asplocalization | LegacyUtilityForwardActionPage |
| settings | careerPortalQuestionnaire | native-explicit | settings.careerportalquestionnaire | LegacyUtilityForwardActionPage |
| settings | careerPortalQuestionnairePreview | native-explicit | settings.careerportalquestionnairepreview | LegacyUtilityForwardActionPage |
| settings | careerPortalQuestionnaireUpdate | native-explicit | settings.careerportalquestionnaireupdate | LegacyUtilityForwardActionPage |
| settings | careerPortalSettings | native-explicit | settings.careerportalsettings | LegacyUtilityForwardActionPage |
| settings | careerPortalTemplateEdit | native-explicit | settings.careerportaltemplateedit | LegacyUtilityForwardActionPage |
| settings | changePassword | native-explicit | settings.changepassword | LegacyUtilityForwardActionPage |
| settings | createBackup | native-explicit | settings.createbackup | LegacyUtilityForwardActionPage |
| settings | customizeCalendar | native-explicit | settings.customizecalendar | LegacyUtilityForwardActionPage |
| settings | customizeExtraFields | native-explicit | settings.customizeextrafields | LegacyUtilityForwardActionPage |
| settings | deleteBackup | native-explicit | settings.deletebackup | LegacyUtilityForwardActionPage |
| settings | deleteEmailTemplate | native-explicit | settings.deleteemailtemplate | LegacyUtilityForwardActionPage |
| settings | deleteUser | native-explicit | settings.deleteuser | LegacyUtilityForwardActionPage |
| settings | editUser | native-explicit | settings.edituser | LegacyUtilityForwardActionPage |
| settings | eeo | native-explicit | settings.eeo | LegacyUtilityForwardActionPage |
| settings | emailSettings | native-explicit | settings.emailsettings | LegacyUtilityForwardActionPage |
| settings | emailTemplates | native-explicit | settings.emailtemplates | LegacyUtilityForwardActionPage |
| settings | feedbackSettings | native-explicit | settings.feedbacksettings | LegacyUtilityForwardActionPage |
| settings | forceEmail | native-explicit | settings.forceemail | LegacyUtilityForwardActionPage |
| settings | gdprSettings | native-explicit | settings.gdprsettings | LegacyUtilityForwardActionPage |
| settings | getFirefoxModal | native-explicit | settings.getfirefoxmodal | LegacyUtilityForwardActionPage |
| settings | googleOIDCSettings | native-explicit | settings.googleoidcsettings | LegacyUtilityForwardActionPage |
| settings | loginActivity | native-explicit | settings.loginactivity | LegacyUtilityForwardActionPage |
| settings | manageUsers | native-explicit | settings.manageusers | LegacyUtilityForwardActionPage |
| settings | myProfile | native-explicit | settings.myprofile | LegacyUtilityForwardActionPage |
| settings | newInstallFinished | native-explicit | settings.newinstallfinished | LegacyUtilityForwardActionPage |
| settings | newInstallPassword | native-explicit | settings.newinstallpassword | LegacyUtilityForwardActionPage |
| settings | newSiteName | native-explicit | settings.newsitename | LegacyUtilityForwardActionPage |
...
| settings | professional | native-explicit | settings.professional | LegacyUtilityForwardActionPage |
| settings | rejectionReasons | native-explicit | settings.rejectionreasons | LegacyUtilityForwardActionPage |
| settings | reports | native-explicit | settings.reports | LegacyUtilityForwardActionPage |
| settings | rolePagePermissions | native-explicit | settings.rolepagepermissions | LegacyUtilityForwardActionPage |
| settings | schemaMigrations | native-explicit | settings.schemamigrations | LegacyUtilityForwardActionPage |
| settings | showUser | native-explicit | settings.showuser | LegacyUtilityForwardActionPage |
| settings | tags | native-explicit | settings.tags | LegacyUtilityForwardActionPage |
| settings | talentFitFlowSettings | native-explicit | settings.talentfitflowsettings | LegacyUtilityForwardActionPage |
| settings | upgradeSiteName | native-explicit | settings.upgradesitename | LegacyUtilityForwardActionPage |
| settings | viewItemHistory | native-explicit | settings.viewitemhistory | LegacyUtilityForwardActionPage |
